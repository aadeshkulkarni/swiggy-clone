      ...
      <div key={index} className="my-4 p-4 grid grid-cols-12 border-b border-gray-200">
        ...
        <div className="col-span-2 flex justify-center items-center relative">
          ...
          {itemsInCart.length > 0 ? (
            <div className="min-w-[70px] w-[70px] absolute text-sm font-bold -bottom-2 left-0 bg-white border border-gray-50 rounded-md uppercase shadow-lg grid grid-cols-12">
            ...
            <button
              ...
              className="absolute text-sm font-bold -bottom-2 left-2 bg-white border border-gray-50 px-6 py-1 rounded-md text-green-600 uppercase shadow-lg"
            >
              ADD
            </button>
          )}
