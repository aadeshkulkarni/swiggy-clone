...
const ItemList = ({ items }) => {
    return items?.map((item) => (<div className="my-4 p-4 grid grid-cols-12 border-b border-gray-200">
        ...
        <div className="col-span-2 flex justify-center items-center relative">
            ...
            <button className="absolute text-sm font-bold -bottom-2 left-12 bg-white border border-gray-50 px-6 py-1 rounded-md text-green-600 uppercase shadow-lg">ADD</button>
        </div>
    </div>))
}
